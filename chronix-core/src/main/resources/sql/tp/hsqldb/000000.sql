...
CREATE CACHED TABLE PUBLIC.ENVIRONMENTVALUE(ID VARCHAR(36) NOT NULL PRIMARY KEY, KEY VARCHAR(50) NOT NULL, VALUE VARCHAR(255), TRANSIENTID VARCHAR(36) NOT NULL);
...
CREATE CACHED TABLE PUBLIC.PIPELINEJOB(ID VARCHAR(36) NOT NULL PRIMARY KEY, ACTIVEID VARCHAR(36) NOT NULL, APPID VARCHAR(36) NOT NULL, 
CALENDARID VARCHAR(36), CALENDAROCCURRENCEID VARCHAR(36), CREATEDAT TIMESTAMP WITH TIME ZONE NOT NULL, IGNORECALENDARUPDATING BOOLEAN, 
OUTSIDECHAINLAUNCH BOOLEAN, PLACEID VARCHAR(36) NOT NULL, SIMULATIONID VARCHAR(36), STATEID VARCHAR(36) NOT NULL, 
VIRTUALTIME TIMESTAMP WITH TIME ZONE NOT NULL, BEGANRUNNINGAT TIMESTAMP WITH TIME ZONE, ENTEREDPIPEAT TIMESTAMP WITH TIME ZONE, KILLAT TIMESTAMP WITH TIME ZONE , LEVEL0ID VARCHAR(36), 
LEVEL1ID VARCHAR(36), LEVEL2ID VARCHAR(36), LEVEL3ID VARCHAR(36), MARKEDFORRUNAT TIMESTAMP WITH TIME ZONE, MUSTLAUNCHBEFORE TIMESTAMP WITH TIME ZONE, 
OUTOFPLAN BOOLEAN, RESULTCODE INTEGER, RUNTHIS VARCHAR(1024), STATUS VARCHAR(20) NOT NULL, STOPPEDRUNNINGAT TIMESTAMP WITH TIME ZONE, 
WARNNOTENDEDAT TIMESTAMP WITH TIME ZONE );

CREATE MEMORY TABLE PUBLIC.EVENT(ID VARCHAR(36) NOT NULL PRIMARY KEY,
ANALYSED BOOLEAN, LOCALONLY BOOLEAN, BESTBEFORE TIMESTAMP WITH TIME ZONE, CONDITIONDATA1 INT, CONDITIONDATA2 VARCHAR(50), CONDITIONDATA3 VARCHAR(50), 
CONDITIONDATA4 VARCHAR(36), ACTIVEID VARCHAR(36) NOT NULL, APPID VARCHAR(36) NOT NULL, CALENDARID VARCHAR(36), 
CALENDAROCCURRENCEID VARCHAR(36), CREATEDAT TIMESTAMP WITH TIME ZONE NOT NULL, IGNORECALENDARUPDATING BOOLEAN, OUTSIDECHAINLAUNCH BOOLEAN, 
PLACEID VARCHAR(36) NOT NULL, SIMULATIONID VARCHAR(36), STATEID VARCHAR(36) NOT NULL, VIRTUALTIME TIMESTAMP WITH TIME ZONE  NOT NULL, 
LEVEL0ID VARCHAR(36), LEVEL1ID VARCHAR(36), LEVEL2ID VARCHAR(36), LEVEL3ID VARCHAR(36));
