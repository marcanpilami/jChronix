...
public class HistoryQuery
{
    ...
    public static enum SortColumn {
        id("id"), applicationName("applicationName"), executionNodeName("executionNodeName"), placeName("placeName"), chainName(
                "chainName"), activeNodeName("activeNodeName"), lastKnownStatus("lastKnownStatus"), markedForRunAt(
                        "markedForUnAt"), stoppedRunningAt("stoppedRunningAt"), chainLaunchId("chainLaunchId");
